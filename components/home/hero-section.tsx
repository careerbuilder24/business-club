...
//       {/* Main Banner */}
//       <div className="flex-1 relative w-full lg:ml-64 md:mt-0"> 
//         {/* Fixed Aspect Ratio Banner Wrapper */}
//         {/* FIX APPLIED HERE: Changed 'lg:aspect-[16/4]' to 'lg:aspect-[16/5]' or 'lg:aspect-[16/6]' 
//            to make the banner taller on large screens. I'll use [16/5] as a good balance. */}
//         <div className="relative w-full aspect-[16/7] sm:aspect-[16/6] md:aspect-[16/5] lg:aspect-[16/5] overflow-hidden">
//           <Image
