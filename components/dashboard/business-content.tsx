...
export default function BusinessContent() {
  ...
  const totalViews = businesses.reduce((acc, b) => acc + b.views, 0);
  const totalServices = businesses.reduce((acc, b) => acc + b.services, 0);
  const totalProducts = businesses.reduce((acc, b) => acc + b.products, 0);
