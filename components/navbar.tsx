...
export default function Navbar() {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Clear token cookie (optional if API already clears it)
      ...
      <div className="bg-white">
        ...
        <div className="w-full mx-auto flex items-center justify-between px-4 py-3 lg:py-2 transition-all duration-300">
          ...
          <div className="hidden lg:flex items-center gap-8 text-sm text-gray-700 justify-center flex-1">
            {navItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="text-[#2C8845] font-bold hover:text-yellow-400  transition-colors"
              >
                {item.label}
              </Link>
            ))}
          ...
          <div className="flex items-center gap-5 text-[#2C8845] ml-4 shrink-0">
            ...
            {!loading && loggedUser ? (
              <>
                <span className="hidden sm:inline px-3 py-2 font-medium">
                ...
                <button
                  ...
                  className="px-3 py-2  font-semibold flex items-center gap-1 hover:bg-gray-100 rounded-md transition text-[#2C8845] hover:text-yellow-400"
                >
                  <LogOut size={18} />
