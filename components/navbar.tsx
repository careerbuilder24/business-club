...
//           <Link
//             href="/"
//             className="flex items-center h-[50px] lg:h-[60px] shrink-0"
//           >
//             <Image
...
//         {/* --- Search Bar (Medium & Small Devices) --- */}
//         <div className="block lg:hidden bg-[#2C8845] px-4 py-3">
//           <div className="flex w-full">
//             <select className="bg-white text-[#2C8845] px-3 py-2 cursor-pointer rounded-l-md outline-none border-none">
//               <option>Business</option>
//               <option>Supplier</option>
...
//               type="text"
//               placeholder="Search..."
//               className="flex-grow px-3 py-2 outline-none text-black border-y border-gray-300 bg-white"
//             />
//             <button className="bg-white text-[#2C8845] px-4 rounded-r-md flex items-center gap-1 font-medium">
//               <Search size={16} />
//               Search
//             </button>
//           </div>
...
export default function Navbar() {
  ...
  return (
    <header className="w-full sticky top-0 z-50 bg-white shadow-md transition-all duration-300 overflow-x-hidden">
      <div className="bg-white">
        ...
        <div className="w-full mx-auto flex items-center justify-between px-4 py-3 lg:py-2 transition-all duration-300">
          ...
          <div className="flex items-center gap-5 text-[#2C8845] ml-4 shrink-0">
            ...
            {/* Add Your Business (Hidden on Mobile - No change needed) */}
            <Link
              href="/add-listing"
              className="hidden lg:flex items-center gap-1 font-medium text-[#2C8845] hover:text-yellow-400"
            >
            ...
            {/* Dashboard: Hide text on non-large devices */}
            <Link
              href="/dashboard"
              // UPDATED: Added lg:flex to ensure it shows the text on large screens,
              // and removed the flex on small screens, relying on the 'items-center'
              // but ensuring the text is hidden.
              className="px-3 py-2 text-black font-semibold flex items-center gap-2 hover:bg-gray-100 rounded-md transition"
            >
              <LayoutDashboard size={18} />
              {/* NEW: Hide text on small/medium screens */}
              <span className="hidden sm:inline">Dashboard</span>
            </Link>

            {/* Login (Hidden on Mobile - No change needed) */}
            <Link
              href="/login"
              className="hidden lg:flex items-center gap-1 hover:text-yellow-300 transition-colors"
            >
            ...
            {/* Mobile Menu Toggle (No change needed - it remains visible on non-lg screens) */}
            <button
              onClick={toggleMenu}
              className="text-[#2C8845] lg:hidden p-1 rounded-md"
            >
        ...
        <div className="block lg:hidden bg-[#2C8845] px-4 py-3">
          <div className="flex w-full">
            <select className="bg-white text-[#2C8845] px-3 py-2 cursor-pointer rounded-l-md outline-none border-none flex-shrink-0">
              <option>Business</option>
              <option>Supplier</option>
              <option>Service</option>
            </select>
            <input
              type="text"
              placeholder="Search..."
              className="flex-grow px-3 py-2 outline-none text-black border-y border-gray-300 bg-white min-w-0"
            />
            <button className="bg-white text-[#2C8845] px-4 rounded-r-md flex items-center gap-1 font-medium flex-shrink-0">
              <Search size={16} />
              Search
            </button>
          </div>
      ...
      {/* --- Watchlist Sidebar Backdrop (New) --- */}
      <div
        onClick={toggleSidebar}
      ...
      {/* --- Watchlist Sidebar (Updated Positioning) --- */}
      <div
        className={`fixed top-0 md:top-20  right-0 h-full w-80 bg-[#2C8845] shadow-2xl z-40
