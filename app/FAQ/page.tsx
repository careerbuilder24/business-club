...
//         <meta
//           property="og:title"
//           content="Frequently Asked Questions | Business Clubs"
//         />
//         <meta
...
//         <meta
//           property="og:url"
//           content="https://business-clubs.vercel.app/faq"
//         />
//         <meta property="og:type" content="website" />
//         <meta
//           property="og:image"
//           content="https://business-clubs.vercel.app/og-image.png"
//         />
...
//         <Sidebar />
//       <section className="max-w-4xl  px-6 py-16  lg:ml-72">
//         <h1 className="text-4xl font-bold text-center mb-10 text-[#2C8845]">
//           (FAQ)Frequently Asked Questions
//         </h1>

//         <Accordion type="single" collapsible className="space-y-4">
//           <AccordionItem value="item-1">
//             <AccordionTrigger className="text-lg font-semibold text-[#2C8845]">
//               What is Business Clubs?
//             </AccordionTrigger>
//             <AccordionContent className="text-[#2C8845]">
//               Business Clubs is an online business listing and hosting platform
//               where users promote their brand, buy domains or hosting, and grow
...
//             </AccordionTrigger>
//             <AccordionContent className="text-[#2C8845]">
//               Create an account, fill out your business info, and submit your
//               listing.
//             </AccordionContent>
//           </AccordionItem>
...
//             </AccordionTrigger>
//             <AccordionContent className="text-[#2C8845]">
//               Yes, we provide domain registration and hosting plans.
//             </AccordionContent>
//           </AccordionItem>
...
//             </AccordionTrigger>
//             <AccordionContent className="text-[#2C8845]">
//               Yes, we provide support & maintenance to keep your business
//               running smoothly.
//             </AccordionContent>
//           </AccordionItem>
...
//             </AccordionTrigger>
//             <AccordionContent className="text-[#2C8845]">
//               Yes, upgrade to premium for SEO boost & featured listings.
//             </AccordionContent>
//           </AccordionItem>
//         </Accordion>
//       </section>
...
export default function FAQPage() {
  return (
    <div className="flex">
      ...
      {/* Main Content */}
      <section className="flex-1 flex justify-center px-4 py-16 lg:ml-72">
        <div className="w-full max-w-4xl">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-[#2C8845]">
                Business Clubs is an online business listing and hosting platform
                where users promote their brand, buy domains or hosting, and
