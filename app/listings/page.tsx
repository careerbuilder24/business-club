...
//       {/* 1. Logo Picture */}
//       <div className="w-24 h-24 mb-3 border border-gray-200 rounded-lg overflow-hidden flex items-center justify-center shadow-md">
//         <img
//           src={listing.logo || "/placeholder.svg"}
//           alt={listing.companyName}
...
//           <span className="font-bold text-gray-700">{listing.rating}</span> ({listing.reviews} reviews)
//         </p>
//       </div>
//     </div>
...
//             {listing.address.city}, {listing.district}
//           </span>
//           <span className="flex items-center">
