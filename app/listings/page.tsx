...
// import { Star, MapPin, Phone, Mail, ChevronDown, Filter } from "lucide-react"; // Added Filter icon
...
//   // State for the category dropdown visibility (used for the inner list)
//   const [isCategoryOpen, setIsCategoryOpen] = useState(true);
//   // NEW STATE: State for the mobile/tablet sidebar visibility (the 'hamburger' part)
...
//   // Handler to select category and close mobile filter
//   const handleCategorySelect = (category: string) => {
//     setSelectedCategory(category);
//     // Automatically close the mobile filter when a category is selected
...
//             Filter Categories ({selectedCategory || "All"})
//           </button>
//         </div>
...
//     lg:col-span-1 lg:block lg:sticky lg:top-0
//     ${
//       isMobileFilterOpen
//         ? "fixed top-0 left-0 h-full w-64 z-50 transform translate-x-0 transition-transform duration-300 ease-in-out lg:translate-x-0"
...
//                   handleCategorySelect(""); // Set to "All"
//                 }}
//                 className={`
...
//           {/* Overlay for mobile filter (only visible when open) */}
//           {isMobileFilterOpen && (
//             <div
