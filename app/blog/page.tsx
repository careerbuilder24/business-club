...
//      <div className="mx-auto grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-6 max-w-full">
//         {/* --- LEFT SIDEBAR --- */}
...
//           <button className="w-full bg-[#016630] text-white border-white border-2 font-bold py-2 rounded-md mb-4">
//             All Blogs
//           </button>
...
export default function BlogPage() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen ">
      ...
      <div className="mx-auto flex flex-col lg:flex-row gap-6 max-w-full">
        
        {/* --- LEFT SIDEBAR (Fixed Width: 250px) --- */}
        <aside className="bg-[#2C8845] text-white p-4 lg:w-[250px] flex-shrink-0 h-[782px] sticky top-4 self-start">
          <button className="w-full bg-[#016630] text-white border-white border-2 font-bold py-2 rounded-md mb-4">
            All Blogs
          </button>
        ...
        {/* --- MIDDLE BLOG LIST (Narrower Width: 50%) --- */}
        {/* 🚀 UPDATED: Changed width from lg:w-3/5 to lg:w-1/2 to make it smaller. */}
        <main className="lg:w-2/5 lg:flex-shrink-0 lg:flex-grow-0 min-w-0 mt-5">
          <div className="mb-4 flex justify-between items-center bg-white border border-gray-200 rounded-md p-3">
            <span className="text-gray-600 text-sm font-medium">
              Total Blogs: {posts.length}
            </span>
        ...
        {/* --- RIGHT ADS (Fixed Width: 300px) --- */}
        <aside className="space-y-4 lg:w-[300px] flex-shrink-0 sticky top-4 self-start">
          {[
            "AD SENSE 1 (150x250)",
            "AD SENSE 2 (150x250)",
            "AD SENSE 3 (150x250)",
